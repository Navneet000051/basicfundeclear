...
<div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Youtube Link <span class="text-danger fw-bold">*</span></label>
                                                    <div class="input-group">
                                                        <input type="url" class="form-control" name="ytlink" value="{{ old('ytlink', !empty($editcontent) ? $editcontent->ytlink : '') }}" required>
                                                        @if(!empty($editcontent))
                                                        <span class="input-group-text" id="showytBtn"> <a href="{{ $editcontent->ytlink}}" target="_blank"><i class="mdi mdi-eye"></i></a></span>
                                                        @endif
                                                        @error('ytlink')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
